...
public class MySurfaceView2 extends SurfaceView implements SurfaceHolder.Callback, Runnable {
    ...
    public MySurfaceView2(Context context, AttributeSet attrs, int defStyle) {
            ...
            switch (mState) {
                case 1 :
                    if (mStateTimer > PUNCH_FRAME - 3 ) {
                        canvas.drawBitmap(BitmapFactory.decodeResource(this.getResources(), R.drawable.p5),0,0,null);
                    } else {
                ...
                case 3 :
                    if (mStateTimer > HOOK_FRAME - 3) {
                        canvas.drawBitmap(BitmapFactory.decodeResource(this.getResources(), R.drawable.p6),0,0,null);
                    } else {
                        canvas.drawBitmap(BitmapFactory.decodeResource(this.getResources(), R.drawable.p4),0,0,null);
                    }
                    break;
    ...
    public void punch2() {mAct = 2;}

    public void punch3() { mAct = 3; }
